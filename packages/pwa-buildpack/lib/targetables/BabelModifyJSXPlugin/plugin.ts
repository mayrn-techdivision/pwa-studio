...
import { Babel, JSXTransformPluginState } from './types';
import { Visitor } from '@babel/traverse';


interface BabelPlugin<S> {
    visitor: Visitor<S>;
}

export default function BabelModifyJsxPlugin(babel: Babel): BabelPlugin<JSXTransformPluginState> {
    return {
        visitor: {
            /**
