module.exports = targets => {
    ...
    checkoutPagePaymentTypes.tap(payments =>
        payments.add({
            paymentCode: 'checkmo',
            importPath:
                '@magento/venia-sample-payments-checkmo/src/components/checkmo'
        })
    );
    editablePaymentTypes.tap(editablePaymentTypes => {
        editablePaymentTypes.add({
            paymentCode: 'checkmo',
            importPath:
                '@magento/venia-sample-payments-checkmo/src/components/edit'
        });
    });
    summaryPagePaymentTypes.tap(paymentSummaries =>
        paymentSummaries.add({
            paymentCode: 'checkmo',
            importPath:
                '@magento/venia-sample-payments-checkmo/src/components/summary'
        })
    );
};
